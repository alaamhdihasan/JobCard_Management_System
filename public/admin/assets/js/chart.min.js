...
!(function(t, e) {
    ...
    function w(t, e, i) {
        ...
        let o;
        for (
            e + i > 1 && ((o = 1 / (e + i)), (e *= o), (i *= o)), o = 0; o < 3; o++
        )
            (n[o] *= 1 - e - i), (n[o] += e);
        return n;
    }
            ...
            (function(t) {
                ...
                if (e) {
                    ...
                    return (
                        ...
                        (i = 255 & (e[2] ? p(i) : i)),
                        (n = 255 & (e[4] ? p(n) : n)),
                        (o = 255 & (e[6] ? p(o) : o)), { r: i, g: n, b: o, a: s }
                    );
                }
            })(t) :
            C(t);
    ...
    var Xe = {
        ...
        update(t, e, i, n) {
            ...
            const h =
                ...
                u = Object.assign({}, o);
            Ne(u, Re(n));
            const f = Object.assign({ maxPadding: u, w: s, h: a, x: o.left, y: o.top },
                o
            );
            !(function(t, e) {
                let i, n, o;
    ...
    class qe {
        ...
        getMaximumSize(t, e, i, n) {
            return (
                ...
                (i = i || t.height), { width: e, height: Math.max(0, n ? Math.floor(e / n) : i) }
            );
        }
        isAttached(t) {
            return !0;
    ...
    function ki(t, e) {
        ...
        o = i._stacks || (i._stacks = {}), { iScale: s, vScale: a, index: r } = n,
            l = s.axis,
            c = a.axis,
            h = (function(t, e, i) {
    ...
    class Ai {
        ...
        parseObjectData(t, e, i, n) {
            const { xScale: o, yScale: s } = t, { xAxisKey: a = "x", yAxisKey: r = "y" } = this._parsing,
                l = new Array(n);
            let c, h, d, u;
            for (c = 0, h = n; c < h; ++c)
                (d = c + i),
        ...
        getMinMax(t, e) {
            ...
            for (
                u = 0; u < a && (m() || (i.updateRangeFromParsed(c, t, g, l), !s));
                ++u
            );
            if (s)
                for (u = a - 1; u >= 0; --u)
            ...
            e.configure(),
                ...
                (i._clip = (function(t) {
                    ...
                    return (
                        ...
                        (e = i = n = o = t), { top: e, right: i, bottom: n, left: o }
                    );
                })(
                    K(
                        e.options.clip,
    ...
    function Fi(t, e, i, n, o) {
        ...
        let r,
            ...
            h = 0;
        for (
            i = Math.ceil(i), o && ((r = o - n), (i = r / Math.floor(r / i))), c = s; c < 0;
    ...
    class ji extends Oi {
        ...
        getUserBounds() {
            ...
            return (
                ...
                (n = q(n, Number.NEGATIVE_INFINITY)), { min: q(t, i), max: q(e, n), minDefined: X(t), maxDefined: X(e) }
            );
        }
        getMinMax(t) {
            const e = this;
            ...
            if (i.display)
                for (l = 0, c = r.length; l < c; ++l) {
                    ...
                    i.drawOnChartArea && h({ x: t.x1, y: t.y1 }, { x: t.x2, y: t.y2 }, t),
                        i.drawTicks &&
                        h({ x: t.tx1, y: t.ty1 }, { x: t.tx2, y: t.ty2 }, {
                            color: t.tickColor,
                            width: t.tickWidth,
        ...
        drawTitle() {
            ...
            const {
                ...
                return (
                    ...
                    ((h = zi(t, i, e)),
                        (d = o(n, r, s)),
                        (u = "left" === i ? -Mt : Mt)), { titleX: h, titleY: d, maxWidth: c, rotation: u }
                );
            })(this, l, e, r);
            te(t, i.text, 0, 0, s, {
                color: i.color,
    ...
    function bn(t, e, i) {
        ...
        a = e.length, { compare: r, between: l, normalize: c } = mn(n), {
                start: h,
                end: d,
                loop: u,
            } = (function(t, e, i) {
                const { property: n, start: o, end: s } = i, { between: a, normalize: r } = mn(n),
                    l = e.length;
                let c,
                    h, { start: d, end: u, loop: f } = t;
                if (f) {
                    for (
                        d += l, u += l, c = 0, h = l; c < h && a(r(e[d % l][n]), o, s);
                        ++c
                    )
                        d--, u--;
                    (d %= l), (u %= l);
        ...
        update(t) {
            ...
            if (
                (e.ensureScalesHaveIDs(),
                    ...
                    e._plugins.invalidate(), !1 === e.notifyPlugins("beforeUpdate", { mode: t, cancelable: !0 }))
            )
                return;
                    ...
                    (function(t, e, i, n) {
                        ...
                        return (
                            ...
                            ((s = e.min * i.categoryPercentage),
                                (a = i.barPercentage)) :
                            ((s = o * n), (a = 1)), { chunk: s / n, ratio: a, start: e.pixels[t] - s / 2 }
                        );
                    })(t, e, o, n),
            ...
            (h ?
                ...
                (function(t, e, i) {
                    ...
                    for (
                        ...
                        t.stroke();
                    for (
                        t.beginPath(), t.arc(n, o, l, s, s + bt), h = 0; h < e.fullCircles;
                        ++h
                    )
                        t.stroke();
                })(t, e, h),
        ...
        draw(t) {
            ...
            if (
                ((e.pixelMargin = "inner" === i.borderAlign ? 0.33 : 0),
                    (e.fullCircles = Math.floor(e.circumference / bt)), !(0 === e.circumference || e.innerRadius < 0 || e.outerRadius < 0))
            ) {
    ...
    function xo(t, e, i, n) {
        const { points: o, options: s } = e, { count: a, start: r, loop: l, ilen: c } = mo(o, i, n),
            h = (function(t) {
                return t.stepped ? Qt : t.tension ? Jt : po;
            })(s);
        let d,
            u,
            f, { move: g = !0, reverse: p } = n || {};
        for (d = 0; d <= c; ++d)
            (u = o[(r + (p ? c - d : d)) % a]),
            u.skip ||
    ...
    function ko(t, e) {
        ...
        return (
            ...
            ((d = s / 2),
                ...
                (l = i + d),
                (c = Math.min(n, o)),
                (h = Math.max(n, o))), { left: r, top: c, right: l, bottom: h }
        );
    }
    ...
    function zo(t, e, i) {
        const n = (function(t) {
            ...
            return (
                void 0 === n && (n = !!e.backgroundColor), !1 !== n && null !== n && (!0 === n ? "origin" : n)
            );
        })(t);
    ...
    function Xo(t, e, i, n) {
        ...
        let o = e[t],
            s = i[t];
        return (
            "angle" === t && ((o = Bt(o)), (s = Bt(s))), { property: t, start: o, end: s }
        );
    }
    ...
    const Jo = (t, e) => {
        ...
        return (
            t.usePointStyle && ((i = Math.min(i, e)), (n = Math.min(n, e))), { boxWidth: n, boxHeight: i, itemHeight: Math.max(e, i) }
        );
    };
    class ts extends Oi {
        constructor(t) {
        ...
        _drawArgs(t) {
            ...
            return (
                ...
                ("left" === a.position ?
                    ...
                    (l = n - e)), { titleX: c, titleY: h, maxWidth: l, rotation: d }
            );
        }
        draw() {
            const t = this,
    ...
    function ds(t, e, i, n) {
        const { caretSize: o, caretPadding: s, cornerRadius: a } = t, { xAlign: r, yAlign: l } = i,
        c = o + s,
            h = a + s;
        let d = (function(t, e) {
            let { x: i, width: n } = t;
        ...
        return (
            ...
            "left" === r ?
            (d -= h) :
            "right" === r && (d += h), { x: Ht(d, 0, n.width - e.width), y: Ht(u, 0, n.height - e.height) }
        );
    }
    ...
    class ps extends Oi {
        ...
        getCaretPosition(t, e, i) {
            ...
            return (
                ...
                ((u =
                    ...
                    (m = g)), { x1: d, x2: u, x3: f, y1: g, y2: p, y3: m }
            );
        }
        drawTitle(t, e, i) {
            const n = this,
        ...
        drawBackground(t, e, i, n) {
            const { xAlign: o, yAlign: s } = this, { x: a, y: r } = t, { width: l, height: c } = i,
            h = n.cornerRadius;
        ...
        buildTicks() {
            ...
            const o = (function(t, e) {
                ...
                for (
                    ...
                    (i.push({ value: o }),
                        x <= o && v++,
                        Ot(Math.round((x + v * y) * m) / m, o, y / 10) && v++); v < _;
                    ++v
                )
            ...
            e.save(),
                ...
                t.ticks.forEach((o, r) => {
                    ...
                    if (
                        ...
                        e.fillRect(-a / 2 - t.left, -s - c.size / 2 - t.top,
                            a + t.width,
                            c.size + t.height
                        );
                    }
